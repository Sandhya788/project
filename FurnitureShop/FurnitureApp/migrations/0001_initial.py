# Generated by Django 3.2.4 on 2021-08-06 18:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icategory', models.CharField(choices=[('NV', 'beds and tables'), ('VG', 'chairs and sofas'), ('Df', 'Select Item')], default='Df', max_length=12)),
                ...
                ('rsid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='FurnitureApp.furnitureshop')),
            ],
        ),
    ]
